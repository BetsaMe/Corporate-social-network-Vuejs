            ...
            <form @submit.prevent="createPost" enctype="multipart/form-data">
                <div class="headerFeed shadow-sm p-3 mt-3">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input v-model="title" type="text" class="form-control" id="formTitle" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea v-model="content" class="form-control" id="formContent" rows="3" maxlength="250" placeholder="Ecrire ton commentaire"></textarea>
                    </div>
                    <div class="">
