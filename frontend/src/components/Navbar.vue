    ...
    <nav class="navbar navbar-light bg-light">
      <div class="container-fluid menuNav">
        <router-link class="navbar-brand" to="/">
          <img
            class="logoRec"
            :src="logoEntreprise.source1"
            :alt="logoEntreprise.alt"
            height="30"
          />
          <img
            class="logoCarre"
            :src="logoEntreprise.source2"
            :alt="logoEntreprise.alt"
            height="35"
          />
        </router-link>
        <form>
          <input
            class="inputsearch form-control rounded-pill"
            type="search"
        ...
        <div class="d-flex align-items-center">
          <a class="nav-link" href="/"
            ><i class="fas fa-bell btn-icon-blue"></i
          ></a>
          <a
            class="nav-link btn-icon-blue"
            aria-current="page"
            href=""
            @click="handleLogout"
            >Logout</a
          ...
          <div class="dropdown">
            ...
            >
              <li>
                <router-link
                  class="dropdown-item"
                  :to="{ name: 'profile', params: { userId: userInfo.id } }"
                  >Profil</router-link
                >
              </li>
              ...
              <li>
                <a
                  class="dropdown-item btn-icon-blue"
                  href=""
                  @click="handleLogout"
                  >Logout</a
                >
